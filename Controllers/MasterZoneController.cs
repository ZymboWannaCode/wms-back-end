    ...
    public class MasterZoneController(IConfiguration configuration) : Controller
    {
        ...
        public IActionResult GetDataZone([FromBody] dynamic data)
        {
            try
            {
                ...
                dt = lib.CallProcedure("wms_getDataZone", EncodeData.HtmlEncodeObject(value));
        ...
        [Authorize]
        [HttpPost]
        public IActionResult GetListZone([FromBody] dynamic data)
        {
            try
            {
                JObject value = JObject.Parse(data.ToString());
                dt = lib.CallProcedure("wms_getListZone", EncodeData.HtmlEncodeObject(value));
                return Ok(JsonConvert.SerializeObject(dt));
            }
            catch { return BadRequest(); }
        }
        ...
        public IActionResult GetDataZoneById([FromBody] dynamic data)
        {
            ...
            {
                JObject value = JObject.Parse(data.ToString());
                dt = lib.CallProcedure("wms_getDataZoneById", EncodeData.HtmlEncodeObject(value));
                return Ok(JsonConvert.SerializeObject(dt));
            }
            catch { return BadRequest(); }
        }
        ...
        [Authorize]
        [HttpPost]
        public IActionResult GetLastZoneId([FromBody] dynamic data)
        {
            try
            {
                JObject value = JObject.Parse(data.ToString());
                dt = lib.CallProcedure("wms_getLastZoneId", EncodeData.HtmlEncodeObject(value));
                return Ok(JsonConvert.SerializeObject(dt));
            }
            catch { return BadRequest(); }
        }
        ...
        [Authorize]
        [HttpPost]
        public IActionResult SetStatusZone([FromBody] dynamic data)
        {
            try
            {
                JObject value = JObject.Parse(data.ToString());
                dt = lib.CallProcedure("wms_setStatusZone", EncodeData.HtmlEncodeObject(value));
                return Ok(JsonConvert.SerializeObject(dt));
            }
            catch { return BadRequest(); }
        }
